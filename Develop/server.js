...
//functions that will display information without user input
...
//functions that will add employees, roles, or departments
...
//functions that will update information
function updateRole() {
  inquirer
    .prompt([
      {
